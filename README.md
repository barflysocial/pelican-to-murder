...
- Detective Notes with autosave status
- Message Host / email issue popup
...
- `public/assets/barfly-social-logo-title-9x16.png` — shared 9:16 Barfly Social title graphic
...
```json
{
  "titleGraphic": "/assets/barfly-social-logo-title-9x16.png",
