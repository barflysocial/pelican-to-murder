  ...
  return `
    <article class="tableCard">
      ...
      <div class="actions" style="margin-top:12px">
        <button class="good" onclick="startBriefing('${s.sessionCode}')">Start Briefing</button>
        <button class="secondary" onclick="startTable('${s.sessionCode}')">Start Investigation</button>
      ...
      <div class="card" style="box-shadow:none">
        ...
        <div class="actions compactButtons">
          <button class="secondary" onclick="startBriefing('${s.sessionCode}')">Briefing</button>
...
window.startBriefing = async code => {
  await api(`/api/sessions/${code}/briefing`, { method: 'POST' });
};
