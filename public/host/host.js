...
async function createSession() {
  ...
  const scheduledStartAt = createLocalScheduledStartAt(eventDate, eventTime);
  ...
  try {
    const state = await api('/api/sessions', { method: 'POST', body: { tableName, truthPackId, playerCap, eventDate, eventTime, eventDurationMinutes, eventStatus, eventType, sharedAccessCode, allowLateCheckIn, scheduledStartAt, autoStartEnabled } });
    upsertSession(state);
