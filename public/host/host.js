...
function tableHtml(s) {
  ...
  return `
    <article class="tableCard">
      ...
      <details class="advancedHostDetails" data-host-details-key="advanced-${s.sessionCode}">
        <summary>Advanced Testing / Emergency Controls</summary>
        <div class="card" style="box-shadow:none">
          ...
          <h3 style="margin-top:14px">Emergency Controls</h3>
          <div class="actions compactButtons">
          ...
          <p class="mini">Use these only for testing or emergency recovery. They are hidden by default to prevent live-game mistakes.</p>
        </div>
      </details>
