  ...
  return `
    <article class="tableCard">
      ...
      <div class="actions" style="margin-top:12px">
        <button class="good" onclick="startBriefing('${s.sessionCode}')">Start Game</button>
      ...
      <div class="card" style="box-shadow:none">
        ...
        <div class="actions compactButtons">
          ...
          <button class="secondary" onclick="startTable('${s.sessionCode}')">Skip to Investigation</button>
