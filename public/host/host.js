...
async function createSession() {
  ...
  const truthPackId = $('truthPackSelect').value || 'pelican-to-murder';
    ...
    <article class="tableCard">
      ...
      <div class="card" style="box-shadow:none">
        ...
        <div class="actions compactButtons">
          ...
          <button class="secondary" onclick="jumpToRound('${s.sessionCode}', 3)">Cover-Up</button>
          <button class="secondary" onclick="jumpToRound('${s.sessionCode}', 4)">Accuse</button>
...
window.resetTable = async code => {
  if (confirm('Reset this table to lobby and clear messages, submissions, and results?')) await api(`/api/sessions/${code}/reset`, { method: 'POST' });
};
