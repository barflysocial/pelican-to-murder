...
function renderSession(info) {
  sessionInfo = info;
  $('sessionTitle').textContent = info.tableName || 'Barfly Social Mystery Check-In';
  $('sessionMeta').textContent = `${info.truthPackTitle || 'Barfly Social Mystery'} · ${info.eventDateLabel || 'Date TBD'} · ${info.eventTimeLabel || 'Time TBD'}`;
