...
function renderSession(info) {
  sessionInfo = info;
  $('sessionTitle').textContent = info.tableName || 'Barfly Mystery Template Check-In';
  $('sessionMeta').textContent = `${info.truthPackTitle || 'Barfly Mystery Template'} · ${info.eventDateLabel || 'Date TBD'} · ${info.eventTimeLabel || 'Time TBD'}`;
