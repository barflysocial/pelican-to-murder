...
async function loadRsvpSessions() {
  ...
  try {
    ...
    msg.textContent = 'Choose your event, then RSVP. You still need a paid access code to enter the game.';
  } catch (err) {
...
async function submitRsvp() {
  ...
  const guestCount = $('rsvpGuests').value || 1;
  ...
  try {
    ...
    msg.innerHTML = '✅ RSVP saved. You are on the case list. Pay the host or event page to receive your personal access code. You cannot enter the live game until you have that code.';
  } catch (err) {
