...
function defaultBriefingSegments(pack = {}) {
  return [
    { startSec: 0, endSec: 60, title: 'The Location', text: 'Pelican to Mars was supposed to be another neon-lit night of cocktails, music, and familiar faces pretending not to notice each other. Tonight, the bar becomes the scene of a live investigation.' },
    { startSec: 60, endSec: 120, title: 'The Crime', text: 'During the launch party, Lena Broussard collapsed near the lounge after stepping away from the crowd. At first it looked like a medical emergency. Then the timeline, the missing item, and the room itself stopped making sense.' },
    { startSec: 120, endSec: 180, title: 'The Victim', text: 'Lena was not just a guest. She knew who was lying, where the money went, and which relationships inside the bar were already breaking. Her questions made people nervous before the first drink was poured.' },
    { startSec: 180, endSec: 240, title: 'The Suspects', text: 'Tessa knew Lena personally. Owen had business ties that depended on silence. Brielle needed the night to look perfect. Cole had a public conflict with Lena. Marisol seemed to understand the room too well.' },
    { startSec: 240, endSec: 300, title: 'Your Assignment', text: 'You are not here to guess. Follow phone records, messages, maps, money, photos, social posts, files, and the room itself. When the investigation begins, every clue matters.' }
  ];
}
