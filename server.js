...
function servePlayerWithRichPreview(req, res) {
  ...
  const imageUrl = `${origin}/assets/barfly-social-title-lounge-bg.png`;
...
function clientState(session) {
  ...
  return {
    ...
    venue: session.venueName || pack.venue || pack.venueName || 'Fictional Baton Rouge Venue',
    venueName: session.venueName || pack.venueName || pack.venue || 'Fictional Baton Rouge Venue',
  ...
  const items = Array.from(sessions.values())
    ...
    .map(session => {
      ...
      return {
        ...
        venue: session.venueName || pack.venue || pack.venueName || 'Fictional Baton Rouge Venue • Baton Rouge, Louisiana',
        venueName: session.venueName || pack.venueName || pack.venue || 'Fictional Baton Rouge Venue',
        venueLogoUrl: session.venueLogoUrl || pack.venueLogoUrl || '',
        ...
        ticketPrice: normalizeTicketPrice(session.ticketPrice || session.eventPrice || ''),
        eventPriceLabel: eventPriceLabel(session),
        titleGraphic: pack.titleGraphic || pack.titleImage || pack.coverImage || '/assets/barfly-social-title-lounge-bg.png',
